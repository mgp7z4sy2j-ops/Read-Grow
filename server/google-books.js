...
function extractPriceUsd(volume) {
  ...
  // Simple fixed conversions for common catalogue currencies (MVP estimate)
...
/**
 * Resolve live price and budget eligibility.
 * Prefers Google Books price; falls back to catalogue price when Google has no retail price.
 */
